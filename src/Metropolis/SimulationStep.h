...
namespace SimCalcs {
  ...
  /**
   * GPU calculation for angleEnergy below.
    */
  __global__
  void calcAngleEnergy(Real** angleData, Real* angleSizes, 
  ...
  /**
   * GPU Calculation for bondEnergy below.
   */
  __global__
  void calcBondEnergy(Real** bondData, Real* bondLengths, 
			Real d_out, int bondStart, int bondEnd);
  ...
  /**
   * Does the same as unionAtoms, but on the GPU.
   *
   */
  __device__
  void unionAtomsGPU(int atom1, int atom2, SimBox* simBox);
  ...
  /**
   * Does the same as find, but on the GPU.
   *
   */
  __device__
  void findGPU(int atomIdx, SimBox* simBox, int retVal);
   ...
   */
  __global__
  void disjointAtomsInMolecule(int molSize, SimBox* simBox);
